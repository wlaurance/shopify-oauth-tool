...
(function() {
  var fs, get_scope, program, repl, request, spawn, tokenmachine;
  ...
  fs.readFile(__dirname + '/../package.json', function(error, data) {
    var base, getTempToken, scope, url;
    if (error != null) {
      throw error;
    }
    ...
    getTempToken = function() {
      return tokenmachine(url, "Copy the ?code param from the callback url here:", function(temp_token) {
